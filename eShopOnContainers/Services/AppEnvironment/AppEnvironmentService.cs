...
// Here's is injecting all the services that the entire app will use with their interfaces 
// to be a centralized declaration that will be declared in the MauiProgram.cs, to ultimatly add 
// in the whole app these services 
// It manages the switching registration if it's in "real" mode or "mock" mode, but it's registering 
// in the mauiprogram.cs anyways. 
